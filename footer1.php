      ...
      <footer class="footer">
        <div class="container">
          <div class="footer__messengers">
            <ul class="footer__messengers-list">
              <li class="footer__messengers-item footer__messengers-item--viber"><a href="<?php echo carbon_get_theme_option('site_viber-link'); ?>" class="footer__messengers-link">
              ...
              <li class="footer__messengers-item footer__messengers-item--telegram"><a href="<?php echo carbon_get_theme_option('site_telegram-link'); ?>" class="footer__messengers-link">
              ...
              <li class="footer__messengers-item footer__messengers-item--whatsapp"><a href="<?php echo carbon_get_theme_option('site_whatsapp-link'); ?>" class="footer__messengers-link">
              ...
              <li class="footer__messengers-item footer__messengers-item--instagram"><a href="<?php echo carbon_get_theme_option('site_instagram-link'); ?>" class="footer__messengers-link">
      ...
      <div class="modal__wrap">
        ...
        <div class="container container--modal">
          <div class="modal__content modal__content--call-form answers answers--call-form">
            <div class="modal__icon-close-wrap closeFormBtn">
              <span class="modal__icon-close"></span>
            </div>
            <h2 class="answers__form-title">
              Заказать звонок
            </h2>
            ...
            <form class="answers__form">
              <div class="answers__form-inner">
                ...
                <button type="submit" class="action action--submit-form">
                  отправить
                </button>
              </div>
            </form>
          </div>
          <div class="modal__content modal__content--order-transport answers answers--call-form">
            <div class="modal__icon-close-wrap closeFormBtn">
              <span class="modal__icon-close"></span>
            </div>
            <h2 class="answers__form-title">
            ...
            <form class="answers__form">
              <div class="answers__form-inner">
                <input type="text" class="input-field input-field--disabled transport-name" placeholder="Средство" name="transport-name">
                <input type="text" class="input-field" placeholder="Ваше имя" name="transport-person" required="">
                <input type="tel" class="input-field input-field--phone" placeholder="Ваш номер телефона" name="person-phone" required="">
          ...
          <div class="modal__content modal__content--success-send modal-notification modal-notification--ok">
            <div class="modal__icon-close-wrap closeFormBtn">
              <span class="modal__icon-close"></span>
            </div>
